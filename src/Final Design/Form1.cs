...
namespace Medicine_Store
{
    public partial class Form1 : Form
    {
        ...
        private void Add_Click(object sender, EventArgs e)
        {
            ...
            businessLayer.InsertCompanyMedicine( name, address, phone_number);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            string id;
            id = Name.Text;
            businessLayer.GetCompany(id);

            CompanyReport companyReport = new CompanyReport(id);
            companyReport.Show();
        }

        private void button2_Click(object sender, EventArgs e)
        {
            All_CompaniesReport report = new All_CompaniesReport();
            report.Show();
        }
    }
}
