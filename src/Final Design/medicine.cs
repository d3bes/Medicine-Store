...
namespace Medicine_Store
{
    public partial class medicine : Form
    {
        ...
        {
          //  int _id = (int)numeric_ID;
            string _name = Name_Medicin_text.Text;
            string _description = _description_text.Text;
            decimal _price = Convert.ToDecimal(_price_text.Text);
            int _quantity = Convert.ToInt32(numeric_quantity.Text);
            int _company_Id = Convert.ToInt32(numeric_Company_ID.Text);
        ...
        {
            string ItemName = Name_Medicin_text.Text;
            businessLayer.GetItemDetails(ItemName);
            ItemDetailsForm itemDetails = new ItemDetailsForm(ItemName);
            itemDetails.Show();
        }

        private void button5_Click(object sender, EventArgs e)
        {
            All_MedicineReport report = new All_MedicineReport();
            report.Show();
        }
    }
}
